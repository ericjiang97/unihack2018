...
public class CommonTestSupport {
    ...
    public static final String USER_PASSWORD = "<not_known>";
    ...
    public static final MonashSamlUser USER_DETAILS = new MonashSamlUser(USER_NAME, USER_PASSWORD, AUTHORITIES);
