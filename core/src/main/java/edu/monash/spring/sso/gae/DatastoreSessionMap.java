package edu.monash.spring.sso.gae;
...
import static edu.monash.spring.sso.gae.SessionManagerUtil.deserialize;
import static edu.monash.spring.sso.gae.SessionManagerUtil.serialize;
...
public class DatastoreSessionMap implements Map<String, Session> {
    ...
    private MapSession createSessionFromEntity(Entity entity) {
        ...
        Map<String, Object> valueMap = (Map<String, Object>) deserialize(blobValue.get().toByteArray());
    ...
    private Entity createEntityForSession(MapSession data) {
        ...
        BlobValue.Builder blobBuilder =
                BlobValue.newBuilder(Blob.copyFrom(serialize(valueMap)));
